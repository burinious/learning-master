    ...
    <div class="scroll-sidebar">
        ...
        <div class="user-profile">
            ...
            <div class="profile-img"> 
                ...
                <?php if($the_student->pix != ""): ?>
                    <img src="/the_students/<?php echo e($the_student->pix); ?>" alt="user" class="img-responsive img-circle" style="max-width:150px;max-height:150px"/>
                <?php else: ?> 
            ...
            <div class="profile-text">
                <h5><?php echo Query::getFullname('students',$student_id); ?></h5>
                <a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"><i class="mdi mdi-settings"></i></a>
                <a href="<?php echo e(route('studentLogout')); ?>" onclick="return confirm('Logout?')" class="" data-toggle="tooltip" title="Logout"><i class="mdi mdi-power"></i></a>
                <div class="dropdown-menu animated flipInY">
                    <!-- text-->
                    <a href="<?php echo e(route('studentProfile')); ?>" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
                    <!-- text-->
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li> <a class="waves-effect waves-dark" href="<?php echo e(route('studentDashboard')); ?>" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard</span></a></li>

                <li> <a class="waves-effect waves-dark" href="<?php echo e(route('studentTutors')); ?>" aria-expanded="false"><i class="mdi mdi-account-multiple-outline"></i><span class="hide-menu">Tutors</span></a></li>

                <li> <a class="waves-effect waves-dark" href="<?php echo e(route('studentAppointments')); ?>" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Appointments</span></a></li>

                <li> <a class="waves-effect waves-dark" href="<?php echo e(route('studentSubjects')); ?>" aria-expanded="false"><i class="mdi mdi-comment-multiple-outline"></i><span class="hide-menu">Subjects</span></a></li>

                <li> <a class="waves-effect waves-dark" href="<?php echo e(route('studentChat')); ?>" aria-expanded="false"><i class="mdi mdi-comment-multiple-outline"></i><span class="hide-menu">Chat</span></a></li>

                <li> <a class="waves-effect waves-dark" href="<?php echo e(route('studentGroups')); ?>" aria-expanded="false"><i class="mdi mdi-group"></i><span class="hide-menu">Groups</span></a></li>

                <li> <a class="waves-effect waves-dark" href="<?php echo e(route('studentMaterials')); ?>" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Materials</span></a></li>

                <li> <a class="waves-effect waves-dark" href="<?php echo e(route('studentAssignments')); ?>" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Assignments</span></a></li>

                <li> <a class="waves-effect waves-dark" href="<?php echo e(route('studentQuiz')); ?>" aria-expanded="false"><i class="fa fa-question"></i><span class="hide-menu">Quiz</span></a></li>
                ...
                <form class="form-horizontal" id="update_profile_form" method="POST" onsubmit="return false">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 pull-left">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="surname" value="<?php echo e($the_student->surname); ?>">
                        </div>

                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Firstname</label>
                            <input type="text" class="form-control" name="firstname"  value="<?php echo e($the_student->firstname); ?>">
                        </div>

                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Email address</label>
                            <input type="email" class="form-control" name="email"  value="<?php echo e($the_student->email); ?>">
                        </div>

                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Phone number</label>
                            <input type="text" class="form-control" name="phone"  value="<?php echo e($the_student->phone); ?>">
                        </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12  pull-right">
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Class</label>
                                <?php echo Misc::selectedClass($the_student->class); ?>

                        </div>

                        <div class="form-group">
                            <label class="control-label">Address</label>
                            <textarea style="margin-top:10px" name="address" rows="5" class="form-control"><?php echo e($the_student->address); ?></textarea>
                        </div>

                        <div class="form-group">
                            <label class="control-label">About me</label>
                            <textarea style="margin-top:10px" name="about" rows="5" class="form-control"><?php echo e($the_student->about); ?></textarea>
                        </div>
