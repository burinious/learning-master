            ...
            <div class="login-box card container">
                ...
                <div class="card-body">
                    <div class="col-xs-12" align="center">
                        <a href="<?php echo e(route('tutorIndex')); ?>"  class="btn btn-success btn-sm text-uppercase waves-effect waves-light">Go to tutors' panel <i class="fa fa-arrow-circle-right"></i></a>
                    </div> <br/>
                    <form class="form-horizontal form-material" method="post" id="loginform" action="<?php echo e(route('studentSignin')); ?>" onsubmit="return false">
...
<?php echo $__env->make('students.front_app', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>