    ...
    @if(Session::has('student_id')) 
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                    <h2> Welcome back, {{$student_fullname}} </h2>
                    <br/>
                    @if(session('error'))
                            ...
                            <div class="card-body">
                                ...
                                @else
                                    <ul class="feeds">
                                        ...
                                        @endforeach
                                        <div align="center">
                                            <a href="{{ route('studentMaterials') }}" class="btn btn-md btn-primary btn-rounded" type="button">All materials <i class="fa fa-arrow-circle-right"></i></a>
                                        </div>
                                    @endif
                                </ul>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    @else
                                        <ul class="feeds">
                                            ...
                                            <div align="center">
                                                <a href="{{ route('studentAssignments') }}" class="btn btn-md btn-primary btn-rounded" type="button">All assignments <i class="fa fa-arrow-circle-right"></i></a>
                                            </div>
                                        </ul>
                                    @endif
                                </div>
