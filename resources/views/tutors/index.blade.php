            ...
            <div class="login-box card container">
                ...
                <div class="card-body">
                    <div class="col-xs-12" align="center">
                        <a href="{{ route('studentIndex') }}"  class="btn btn-success btn-sm text-uppercase waves-effect waves-light">Go to students' panel <i class="fa fa-arrow-circle-right"></i></a>
                    </div> <br/>
                    <form class="form-horizontal form-material" method="post" id="loginform" action="{{ route('tutorSignin') }}" onsubmit="return false">
                        {{ csrf_field() }}
                    ...
                    <form class="form-horizontal form-material" id="registerform" action="#" method="post" style="display:none" onsubmit="return false">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                {!! Query::selectItem('subjects','subject_id','-- Select subject --') !!}
                            </div>
                        </div>
                        <div class="form-group ">
                            <div class="col-xs-12">
