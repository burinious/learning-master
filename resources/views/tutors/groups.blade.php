                                    ...
                                    <div class="chat-left-inner">
                                        ...
                                        <ul class="chatonline style-none" id="real_div">
                                            @foreach($groups as $group)
                                                ...
                                                <li onClick="loadGroupDetails('{{$group->group_id}}')">
                                                    <a href="javascript:void(0)"><span id="group_name{{$group->group_id}}"> {{ucwords($group_name)}}                                                    <small class="text-default"> <span id="count_the_members{{$group->group_id}}"> {{$count_group_members}} </span> Members
                                                    </small>
                                                    </span></a>
                                                </li>
                                            @endforeach                                            
                        ...
                        <form class="form-horizontal form-material" id="add_group_form" method="POST" onsubmit="return false" enctype="multipart/form-data">
                            ...
                            <div id="phase_one">
                                ...
                                <div class="modal-footer" style="border:0px">
                                    <button type="button" id="group_details_btn" onclick="return checkTutorGroupDetails()" class="btn btn-info">Continue <i class="fa fa-arrow-circle-right"></i> </button>
                                </div>
                            ...
                            <div id="phase_two" style="display:none">
                                ...
                                <div>
                                    ...
                                    <button type="button" id="add_group_btn" onclick="return ajaxFormRequest('#add_group_btn','#add_group_form','/tutors/add-group','POST','#phase_two_status','Add Group','yes')" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Add Group </button>
                                </div>
