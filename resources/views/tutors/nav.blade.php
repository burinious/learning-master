    ...
    <div class="scroll-sidebar">
        ...
        <div class="user-profile">
            ...
            <div class="profile-img"> 
                ...
                @if($the_tutor->pix != "")
                    <img src="/the_tutors/{{$the_tutor->pix}}" alt="user" class="img-responsive img-circle" style="max-width:150px;max-height:150px"/>
                @else 
            ...
            <div class="profile-text">
                <h5>{!! Query::getFullname('tutors',$tutor_id) !!}</h5>
                <a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"><i class="mdi mdi-settings"></i></a>
                <a href="{{ route('tutorLogout') }}" onclick="return confirm('Logout?')" class="" data-toggle="tooltip" title="Logout"><i class="mdi mdi-power"></i></a>
                <div class="dropdown-menu animated flipInY">
                    <!-- text-->
                    <a href="{{ route('tutorProfile') }}" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
                    <!-- text-->
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li> <a class="waves-effect waves-dark" href="{{ route('tutorDashboard') }}" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard</span></a></li>

                <li> <a class="waves-effect waves-dark" href="{{ route('tutorStudents') }}" aria-expanded="false"><i class="mdi mdi-account-multiple-outline"></i><span class="hide-menu">Students</span></a></li>

                <li> <a class="waves-effect waves-dark" href="{{ route('tutorAppointments') }}" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Appointments</span></a></li>

                <li> <a class="waves-effect waves-dark" href="{{ route('tutorChat') }}" aria-expanded="false"><i class="mdi mdi-comment-multiple-outline"></i><span class="hide-menu">Chat</span></a></li>

                <li> <a class="waves-effect waves-dark" href="{{ route('tutorGroups') }}" aria-expanded="false"><i class="mdi mdi-group"></i><span class="hide-menu">Groups</span></a></li>

                <li> <a class="waves-effect waves-dark" href="{{ route('tutorMaterials') }}" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Materials</span></a></li>

                <li> <a class="waves-effect waves-dark" href="{{ route('tutorAssignments') }}" aria-expanded="false"><i class="mdi mdi-file"></i><span class="hide-menu">Assignments</span></a></li>
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-network-question"></i><span class="hide-menu">Quiz </span></a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{ route('tutorQuiz') }}">All Questions</a></li>
                ...
                <form class="form-horizontal" id="update_profile_form" method="POST" onsubmit="return false">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 pull-left">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="surname" value="{{$the_tutor->surname}}">
                        </div>

                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Firstname</label>
                            <input type="text" class="form-control" name="firstname"  value="{{$the_tutor->firstname}}">
                        </div>

                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Email address</label>
                            <input type="email" class="form-control" name="email"  value="{{$the_tutor->email}}">
                        </div>

                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Phone number</label>
                            <input type="text" class="form-control" name="phone"  value="{{$the_tutor->phone}}">
                        </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12  pull-right">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="margin-top:10px" name="address" rows="5" class="form-control">{{$the_tutor->address}}</textarea>
                        </div>

                        <div class="form-group">
                            <label class="control-label">About me</label>
                            <textarea style="margin-top:10px" name="about" rows="5" class="form-control">{{$the_tutor->about}}</textarea>
                        </div>
