$(function() {
    ...
    $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function() {
        ...
        $("#loginform").slideUp(), $("#registerform").hide('fast'), $("#recoverform").fadeIn();
    }), $("#to-login").on("click", function() {
        $("#recoverform").slideUp(), $("#registerform").hide('fast'), $("#loginform").fadeIn();
    }), $("#to-the-login").on("click", function() {
        $("#recoverform").slideUp(), $("#registerform").hide('fast'), $("#loginform").fadeIn();
    }), $("#to-register").on("click", function() {
        $("#recoverform").slideUp(), $("#loginform").slideUp(), $("#registerform").show().fadeIn();
